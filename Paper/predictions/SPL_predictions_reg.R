...
mat_reg_fitA = createModelLibrary(data = data_reg_mat, 
                                 formula = G3~., 
                                 modellist = modellist,
                                 metric = "RMSE",
...
# B: A without G2
mat_reg_fitB = createModelLibrary(data = data_reg_mat[, !(colnames(data_reg_mat)%in%"G2")], 
                                  formula = G3~., 
                                  modellist = modellist,
                                  metric = "RMSE",
                                  model_setup = model_setup )
...
# A, all the independent variables
por_reg_fitA = createModelLibrary(data = data_reg_por, 
                                  formula = G3~., 
                                  modellist = modellist,
                                  metric = "RMSE",
                                  model_setup = model_setup )
...
# B: A without G2
por_reg_fitB = createModelLibrary(data = data_reg_por[, !(colnames(data_reg_por)%in%"G2")], 
                                  formula = G3~., 
                                  modellist = modellist,
                                  metric = "RMSE",
                                  model_setup = model_setup )
